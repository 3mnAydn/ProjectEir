-- V2__init_test.sql - Test-specific migration for H2 database
-- Run with Flyway on application startup for tests
...
INSERT INTO users (email, password, first_name, last_name, identity_number, enabled) 
VALUES (
    'admin@eir.com', 
    '$2a$10$na4czHNE46FYogPvxjJR4OcT.sPh3kT9iXyK/YGYZYSeD3zw42xEe', 
    'Admin', 
    'User',
    '11111111111',
    true
